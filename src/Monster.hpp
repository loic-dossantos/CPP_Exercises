...
class Monster : public Card {
    ...
    public:
        Monster(const std::string &id, const std::string &name, const Attribute &attribute, const std::string monster_type, int atk, int def) 
        : Card(id, CardType::Monster), _attribute {attribute}, _monster_type {monster_type}, _atk {atk}, _def {def} {
            set_name(name);
        }
